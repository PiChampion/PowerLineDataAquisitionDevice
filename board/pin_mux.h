...
#define BOARD_Yellow_LED_GPIO GPIOB               /*!<@brief GPIO peripheral base pointer */
#define BOARD_Yellow_LED_GPIO_PIN_MASK (1U << 9U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_Yellow_LED_PORT PORTB               /*!<@brief PORT peripheral base pointer */
#define BOARD_Yellow_LED_PIN 9U                   /*!<@brief PORT pin number */
#define BOARD_Yellow_LED_PIN_MASK (1U << 9U)      /*!<@brief PORT pin mask */
                                                  /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_Green_LED_GPIO GPIOB                /*!<@brief GPIO peripheral base pointer */
#define BOARD_Green_LED_GPIO_PIN_MASK (1U << 10U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_Green_LED_PORT PORTB                /*!<@brief PORT peripheral base pointer */
#define BOARD_Green_LED_PIN 10U                   /*!<@brief PORT pin number */
#define BOARD_Green_LED_PIN_MASK (1U << 10U)      /*!<@brief PORT pin mask */
                                                  /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_Red_LED_GPIO GPIOB                /*!<@brief GPIO peripheral base pointer */
#define BOARD_Red_LED_GPIO_PIN_MASK (1U << 23U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_Red_LED_PORT PORTB                /*!<@brief PORT peripheral base pointer */
#define BOARD_Red_LED_PIN 23U                   /*!<@brief PORT pin number */
#define BOARD_Red_LED_PIN_MASK (1U << 23U)      /*!<@brief PORT pin mask */
                                                /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_LED_Button_GPIO GPIOC               /*!<@brief GPIO peripheral base pointer */
#define BOARD_LED_Button_GPIO_PIN_MASK (1U << 0U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_LED_Button_PORT PORTC               /*!<@brief PORT peripheral base pointer */
#define BOARD_LED_Button_PIN 0U                   /*!<@brief PORT pin number */
#define BOARD_LED_Button_PIN_MASK (1U << 0U)      /*!<@brief PORT pin mask */
                                                  /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_Testing_Button_GPIO GPIOD               /*!<@brief GPIO peripheral base pointer */
#define BOARD_Testing_Button_GPIO_PIN_MASK (1U << 0U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_Testing_Button_PORT PORTD               /*!<@brief PORT peripheral base pointer */
#define BOARD_Testing_Button_PIN 0U                   /*!<@brief PORT pin number */
#define BOARD_Testing_Button_PIN_MASK (1U << 0U)      /*!<@brief PORT pin mask */
                                                      /* @} */
